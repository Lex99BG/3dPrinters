...
const ProductDetails = () => {
  ...
  const submitHandler = (e)=>{
    ...
    toast.success("Ревюто е успешно предадено")
  }
    ...
    <Helmet title={productName}>
      ...
      <section className='pt-0'>
        <Container>
          <Row>
            <Col lg='6'>
              <img src={imgUrl} className='img-fluid mt-5' />
            </Col>
            <Col lg='6'>
             <div className="product__details">
              <h2>{productName}</h2>
                ...
                <span className='product__price'>{price} .лв</span>
                <span> Категория: {category.toUpperCase()}</span>
                </div>
                <p className='mt-3'>{shortDesc}</p>
                <motion.button whileTap={{scale:1.2}} className='buy__btn' onClick={addToCart}>Добави в количката</motion.button>
             </div>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <Row>
                  ...
                  <div className="review__wrapper">
                    ...
                    <div className="review__form">
                      ...
                      <form action="" onSubmit={submitHandler}>
                        ...
                        <button whileTap={{scale:1.2}} type='submit' className='buy__btn'>Изпращане</button>
                      </form>
                    </div>
                  </div>
                </div>
            ...
            <Col lg='12' className='mt-5'>
              <h2 className="related__title">Може да харесате също и</h2>
            </Col>
